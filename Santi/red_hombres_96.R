...
#para analizar el tamaño de la muestra de mi dataset:
...
# =======================================================
grafo_hombres <- graph_from_data_frame(d = aristas_finales, vertices = nodos, directed = TRUE)

ggraph(grafo_hombres, layout = 'fr') +
    ...
    scale_size_continuous(range = c(3, 12), name = "Total Hombres") +
    theme_void() +
    labs(title = "Red de Movilidad Laboral Neta - Hombres (1996)")
